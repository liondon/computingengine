...
function varargout = GRE(TE,TR,MatSize,FOV,RF,ADC,GradOn,dummy,slice)
idealDephasing = 1;
    ...
    frqOffset = (Gss.amp/1000) * slice.offset * gamma /2/pi;    % T/m * m * Hz/T, thus in Hz.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if GradOn.pe == 1
            ...
            varargout{1}.Main.Gpe.value = -[0,0,1.5*GMax,0];
