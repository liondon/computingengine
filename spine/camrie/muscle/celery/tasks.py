...
@celery.task(name='camrie.cu', bind=True)
def camrie_simulation(self, jopt):
#    vertebra sends tmpdir a directory where i can write and the position of a json option file as defined in camrieCU version 20201006
    try:
        ...
        command= "sh ./run_camrie.sh /opt/mcr/v96/ " + jopt +" " + outputfile + " "+ logfile + " " + TMPDIR + "/ " + matfile
