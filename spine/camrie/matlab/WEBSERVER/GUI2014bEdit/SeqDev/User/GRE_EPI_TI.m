%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     GRE-EPI with inverse recovery (Fat Sat)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function varargout = GRE_EPI_TI(TE,TR,MatSize,FOV,RF,ADC,GradOn,dummy,slice,TI)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        varargout{1}.Main.ADC.tStep = [startTime,TI.duration+TE+TI.rf.duration/2-ADC.duration/2,...
            temp1,TR-startTime-TE-TI.duration--TI.rf.duration/2-ADC.duration/2]; % ms
        ...
        if GradOn.pe == 1
            ...
            varargout{1}.Main.Gpe.tStep = [startTime,TI.duration+RF.Duration/2+TI.rf.duration/2,...
                Gpe.preph.duration,TE-RF.Duration/2-ADC.duration/2-Gpe.preph.duration,...
                Gpe.duration,TR-TE-startTime-TI.duration-TI.rf.duration/2-ADC.duration/2];
        ...
        if GradOn.fe == 1
            ...
            varargout{1}.Main.Gfe.tStep = [startTime,TE-ADC.duration/2+TI.duration+TI.rf.duration/2-Gfe.preph.duration,...
                Gfe.preph.duration,Gfe.duration,TR-startTime-TI.duration-TE-TI.rf.duration/2-ADC.duration/2]; %ms
