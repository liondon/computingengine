...
function varargout = GRE_EPI(TE,TR,MatSize,FOV,RF,ADC,GradOn,dummy,slice)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if dummy>0
            varargout{1}.Dummy.RF.dPhs = varargout{1}.Main.RF.dPhs;
        ...
        if (idealDephasing == 1)
           ...
           % Real Spoiling
           varargout{1}.Main.ADC.value = [-1,0,ADC.value,0];
        end;
        ...
        if dummy>0
            ...
            if (idealDephasing == 1)
               % Ideal Spoiling
               varargout{1}.Dummy.ADC.value = [-2,0,ADC.value,0];
            else        
               % Real Spoiling
               varargout{1}.Dummy.ADC.value = [-1,0,ADC.value,0];
            end;
        end;
        ...
        if GradOn.fe == 1
            ...
            varargout{1}.Main.Gfe.tStep = [startTime,...
                TE+RF.Duration/2-Gfe.preph.duration-ADC.duration/2,...
