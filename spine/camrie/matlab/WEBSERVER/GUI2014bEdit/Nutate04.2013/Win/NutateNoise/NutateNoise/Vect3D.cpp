...
//	return temp;
//}
//template Vect3D<std::complex<float> > Vect3D<std::complex<float> >::conjugate();

// ------------------------------------------------------------------------------
//
//
//Vect3D<std::complex<float> > conjugat( Vect3D<std::complex<float> > vect)
//{
//	Vect3D< std::complex<float > > temp;
//	temp.x = std::conj(vect.x);
//	temp.y = std::conj(vect.y);
//	temp.z = std::conj(vect.z);
//	return temp;
//}
