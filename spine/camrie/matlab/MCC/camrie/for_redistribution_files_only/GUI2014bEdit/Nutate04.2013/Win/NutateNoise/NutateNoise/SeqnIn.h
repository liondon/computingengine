...
private:
	...
	public:
		...
		unsigned short int numRx;
	} seqnHeader;

	// for noise calculation, the only information needed from the sequence file is
	// timing and aquisition windows. RF and gradients are not used and are skipped.
