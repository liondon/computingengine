...
private:
	...
	public:
		...
		Vect3D<float> min, max; // Vect3D defines an x, y, and z component of min, max, ctr, and wid
		Vect3D<float> ctr;
		Vect3D<float> wid;
	...
	std::vector<Voxel> geomData; // geomData is the object that will receive all voxels as they are imported from the file
	...
	// axisShift is used to change the coordinates of the voxels, shifting the center to the point specified in the header or in the command line
	void axisShift();
