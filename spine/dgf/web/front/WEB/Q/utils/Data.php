...
class Data
{
    ...
    public function getFileIDafterUpload($id,$alias,$t)
    {
            ...
            $query = "SELECT ID as ID, DATEDIFF( CURRENT_TIMESTAMP, dateIN) as TIME FROM data WHERE (UID={$id}  and DATEDIFF( CURRENT_TIMESTAMP, dateIN)<1 and filename='{$alias}') order by dateIN DESC limit 1";
