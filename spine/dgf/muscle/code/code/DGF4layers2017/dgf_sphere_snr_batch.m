...
compute_ult_field_patterns = 1;          % 1 --> compute ultimate E and B field patterns
compute_coil_field_patterns = 1;         % 1 --> compute coil E and B field patterns
...
%--- geometry ---%
preset_fov_geometry_flag = 1;            % 1 --> FOV data is loaded from a .MAT file
preset_coil_geometry_flag = 1;           % 1 --> coil geometry is loaded from file

%--- saved variables ---%
save_emfields_ult_r4_flag = 1;           % 1 --> save a matrix with the modes' electric and magnetic fields in Region 4 (WARNING: large file)
save_emfields_coil_r4_flag = 0;          % 1 --> save a matrix with the coils' electric and magnetic fields in Region 4
save_emfields_ult_r3_flag = 1;           % 1 --> save a matrix with the modes' electric and magnetic fields in Region 3 (WARNING: large file)
save_emfields_coil_r3_flag = 0;          % 1 --> save a matrix with the coils' electric and magnetic fields in Region 3
save_emfields_ult_r2_flag = 1;           % 1 --> save a matrix with the modes' electric and magnetic fields in Region 2 (WARNING: large file)
save_emfields_coil_r2_flag = 0;          % 1 --> save a matrix with the coils' electric and magnetic fields in Region 2
save_emfields_ult_r1_flag = 1;           % 1 --> save a matrix with the modes' electric and magnetic fields in Region 1 (WARNING: large file)
...
save_noise_contributions = 1;            % 1 --> save sample, coil and radiation losses separately
...
plot_coilSNR = 0;                       % 1 --> plot SNR results for circular surface coils
